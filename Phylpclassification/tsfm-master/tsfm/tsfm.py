...
def main():
    ...
    if args.KLDlogo:
        ...
        kld_info, kld_height = logo_dict[key_1].calculate_kld(back_prior=resultsKLD[key_1]['prior'],
        ...
        kld_info, kld_height = logo_dict[key_2].calculate_kld(back_prior=resultsKLD[key_2]['prior'],
