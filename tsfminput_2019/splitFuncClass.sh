...
filenames=$(ls /home/fatemeh/Leishmania_Aug2018/phyloclassification/tsfminput_2019/tRNADB/*.fasta)

array=(A R N D C Q E G H I L K M X F P S T W Y V)

for ref in $filenames; do
    ref2=${ref#"/home/fatemeh/Leishmania_Aug2018/phyloclassification/tsfminput_2019/tRNADB/"}
    ref3=${ref2%".fasta"}
    cd  /home/fatemeh/Leishmania_Aug2018/phyloclassification/tsfminput_2019/tRNADB/
    mkdir "$ref3"
    printf " %s\n" $ref3
mkdir "/home/fatemeh/Leishmania_Aug2018/phyloclassification/tsfminput_2019/tRNADB/$ref3/clustalW"
for item in ${array[*]}
do
    printf "   %s\n" $item
